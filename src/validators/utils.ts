import { ErrorMessage, NumberRule, Rule, StringRule } from "../types/validationTypes";
 ...
 */
export const isPatterns = (value: string, rules: NumberRule | StringRule): ErrorMessage[] => {
