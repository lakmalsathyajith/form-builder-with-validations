...
export const FormBuilder = () => {
    ...
    const handleAddingField = () => {
        ...
        if (currentType && currentKey && currentLabel) {
            dispatch(addField({ key: currentKey, type: currentType as FieldType, label: currentLabel, rules: fieldRuleSet }))
        }
    }
    ...
    return (
        <Fragment>
            ...
            <ValidationModal isOpen={isValidationModalOpen} setIsValidationModalOpen={setIsValidationModalOpen} type={currentType} setFieldRuleSet={setFieldRuleSet} />
        </Fragment>
    )
}